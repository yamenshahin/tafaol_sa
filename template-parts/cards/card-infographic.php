<?php
/**
 * Template Part: Minimalist Infographic Card
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('group flex flex-col bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-500'); ?>>
    ...
    <div class="p-6 flex-1 flex flex-col">
        <span class="text-xs font-semibold text-red-600 tracking-wider uppercase mb-3">
            <?php esc_html_e('Infographic', 'hello-elementor-child'); ?>
        </span>

        <h3
            class="text-xl font-bold text-gray-900 mb-3 leading-snug group-hover:text-red-600 transition-colors duration-300">
        ...
        <div class="mt-auto pt-4 border-t border-gray-50">
            <a href="<?php the_permalink(); ?>"
                class="text-sm font-medium text-gray-900 flex items-center group-hover:text-red-600 transition-colors">
