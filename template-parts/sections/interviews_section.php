...
<section class="department-section interviews-section">
    ...
    <?php
    $more_link = add_query_arg('view', 'interview', get_term_link($department));
    ...
    <div class="section-footer">
        <a href="<?php echo esc_url($more_link); ?>" class="btn btn-view-more">
            <?php esc_html_e('View All Interviews', 'your-textdomain'); ?>
        </a>
    </div>
