...
$section_title = get_sub_field('section_title') ?: __('Government Entities', 'hello-elementor-child');
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div
            ...
            <?php foreach ($active_terms as $data):
                ...
                $image_html = $image_id ? wp_get_attachment_image($image_id, 'medium', false, ['class' => 'w-16 h-16 object-contain opacity-80 group-hover:opacity-100 transition-opacity duration-300']) : '';
                ?>

                <a href="<?php echo esc_url($url); ?>"
                    class="group flex-none w-44 snap-start flex flex-col items-center justify-between p-6 bg-white border border-gray-100 rounded-2xl hover:border-gray-200 hover:shadow-xl hover:shadow-gray-100 hover:-translate-y-1 transition-all duration-300 ease-out">
