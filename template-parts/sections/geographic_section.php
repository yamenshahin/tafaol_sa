            ...
            <div
                ...
                <?php foreach ($countries as $data):
                    ...
                    <a href="<?php echo esc_url($url); ?>"
                        ...
                        <h3 class="text-sm font-medium text-gray-800 text-center mb-3"><?php echo esc_html($term->name); ?></h3>
                        <span
                            class="text-xs font-semibold text-gray-500 bg-gray-50 px-3 py-1 rounded-full group-hover:bg-gray-100 transition-colors">(<?php echo esc_html($count); ?>)</span>
                    </a>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
